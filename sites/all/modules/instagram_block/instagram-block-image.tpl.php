...
<a class="group" target="_blank" data-instagram-rel="1" href="<?php print $href ?>">
  <!--img alt="<?php //print $post->caption->text; ?>" style="float: left; margin: 0 5px 5px 0px; width: <?php //print $width ?>%; height: <?php //print $height ?>%;" src="<?php //print $src ?>"-->
  <img alt="" style="float: left; margin-left:7%; width: <?php print $width ?>%; height: <?php print $height ?>%;" src="<?php print $src ?>">
</a>
